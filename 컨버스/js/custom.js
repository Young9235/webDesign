$(document).ready(function(){
	...
	$(".p41").css({"right":280-(posX/30) , "bottom":30-(posY/30) });
	$(".p42").css({"right":110+(posX/20) , "bottom":-270+(posY/20) });
	$(".p43").css({"right":-70+(posX/20) , "bottom":-130+(posY/20) }); 
	
	//네 번째 박스의 이미지 위치값을 마우스 커서의 위치값과 연동
	$(".p51").css({"right":20-(posX/30) , "bottom":-120-(posY/30) });
	$(".p52").css({"right":0+(posX/20) , "bottom":-180+(posY/20) }); 
	});
...
$(window).on("scroll",function(){ 
  ...
  */
  ...
  $("section").on("mousewheel",function(event,delta){
	  if(delta > 0){
		  //변수 prev에 현재 휠을 움직인 section에서 다음 section의 offset().top위치 저장
